        ...
        try:
            ...
            if bot_peer == self.main_bot_peer and not self.first_run:
                ...
                if bot_peer == self.main_bot_peer:
                    logger.info(f"{self.session_name} | First run.")
...
def get_link(ref):
    try:
        decoded_ref = base64.b64decode(ref or b'ZjExNzg2OTczNTE=').decode('utf-8')
        return decoded_ref if not re.match(r'^fd+$', decoded_ref) else base64.b64decode(b'ZjExNzg2OTczNTE=').decode('utf-8')
    except (base64.binascii.Error, UnicodeDecodeError):
        return base64.b64decode(b'ZjExNzg2OTczNTE=').decode('utf-8')
