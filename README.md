![banner](https://i.ibb.co/jLx0kbR/photo-2024-10-11-15-15-52.jpg)

[![Static Badge](https://img.shields.io/badge/Telegram-Bot%20Link-Link?style=for-the-badge&logo=Telegram&logoColor=white&logoSize=auto&color=blue)](https://t.me/notpixel/app?startapp=f1178697351)
...
## Recommendation before use NotPixel Script.
...
### 🐈🐕 [Cats&Dogs](https://github.com/outputman/catsanddogs)
...
## Installation
You can download the [**repository**](https://github.com/outputman/notpixel) by cloning it to your system and installing the necessary dependencies:
```shell
git clone https://github.com/outputman/notpixel
```
